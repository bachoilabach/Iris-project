...
export default function Header() {
	return (
		<div className="px-28 container min-w-[1140px] py-3 flex justify-between items-center border-b border-[#e4e5ea] backdrop-blur-[15px] bg-white/90 fixed top-0 z-50 ">
			{/* Logo */}
			<div className="w-28">
